...
public class My_WorkBoard extends Board {
    ...
    public My_WorkBoard(My_WorkBoard w) {
	super(w);
    }
...
//----------------------------------------------------------
    ...
    int minimax(int depth, boolean find_move) {

	Vector<Move> moves = genMoves();
	int nmoves = moves.size();
	if (nmoves == 0) {
	    best_move = new Move();
	    My_WorkBoard scratch = new My_WorkBoard(this);
