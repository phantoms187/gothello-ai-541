...
public class My_Grossthello {
    GthClient client;
    My_WorkBoard board = new My_WorkBoard();
    int depth;
    
    public My_Grossthello(GthClient client, int depth) {
	this.client = client;
	this.depth = depth;
    }
	...
	My_Grossthello game = new My_Grossthello(client, depth);
        if (args.length == 5 && args[4].equals("log")) {
            System.err.println("logging");
            System.err.println();
            My_WorkBoard.logging = true;
        }
	game.play();
    }
}
